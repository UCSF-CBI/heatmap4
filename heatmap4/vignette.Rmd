                             ...
                             file_name = NULL, h_title = NULL, ...)
{
  ...
  heatmap4(x = x, Rowv = Rowv, Colv = Colv, distfun = dist,  symm = FALSE,
           ...
           high = cols[1], low = cols[2], mid = cols[3], cexRowSide = cexRowSide, cexColSide = cexColSide, sideLabRow = sideLabRow, sideLabCol = sideLabCol, ...)
...
main_plot = list("sideLabCol" = 2, "sideLabRow" = 4, "cexRowSide" = 3, "cexColSide" = 3)
