...
The data set genomDat is 2x2 matrix with gene expression data (subjects, genes). The phen (phenotype) data set displays the clinical information of the subjects. The anno data set consists of gene mapping information.

```{r}
# Set working directory to heatmap4 and load RData file from github package to access data
