...
col<- select(phen, age..yrs., sex)
col_rows <- ncol(col)
col_columns <- 2
column_df <- as.data.frame(col)
colnames(column_df) <- c("age","sex")
col_info <- column_df
...
FALSE, col_anno_var = c("age","sex"), row_anno_var = c("chrom"), h_title = "Genome Heatmap", 
