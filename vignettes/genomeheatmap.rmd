...
setwd("~/Desktop/heatmap4-master-2")
load(file = 'data_v2.RData')
...
# Sample portion of column annotations df (heatmap examples will use [1:39]) 
print(column_df$age[1:10])

print(column_df$sex[1:8])

# Sample portion of row annotation df (heatmap examples will use [1:22])
print(row_df$chrom[1:10])
...
```{r}
# Default heatmap 
generate_heatmap(genomDat, input_legend = FALSE)
```

```{r}
# Heatmap with column dendrogram
generate_heatmap(genomDat, col_info = column_df, col_dend = TRUE, input_legend = FALSE)
```

```{r}
# Heatmap with column dendrogram, column annotations    
generate_heatmap(genomDat, col_info = column_df, col_dend = TRUE, col_anno = TRUE, 
input_legend = FALSE )
```
...
generate_heatmap(genomDat, col_lab = TRUE, col_info = column_df, 
