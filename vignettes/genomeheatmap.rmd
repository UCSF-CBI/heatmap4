...
```{r}
#empty, heatmap only
generate_heatmap(test, input_legend = FALSE)
```

```{r}
#heatmap with column color bar 
generate_heatmap(test, col_info = column_df, col_anno = TRUE, input_legend = FALSE)
```

```{r}
#heatmap with column color bar, column label    
generate_heatmap(test, col_lab = TRUE, row_lab = FALSE, col_info = column_df, col_anno = TRUE, input_legend = FALSE )
```


```{r}
#heatmap with column color bar, column label, column dendrogram   
generate_heatmap(test, col_lab = TRUE, row_lab = FALSE, col_info = column_df, col_anno = TRUE, col_dend = TRUE, input_legend = FALSE)
```

```{r}
#heatmap with column color bar, column label, column dendrogram, only col 1 anno       
generate_heatmap(test, col_lab = TRUE, row_lab = FALSE, col_info = column_df, col_anno = TRUE, col_dend = TRUE, input_legend = FALSE, col_anno_var = "C1")
```

```{r}
#heatmap with all column and row annotations
generate_heatmap(test, col_lab = TRUE, row_lab = TRUE, col_anno = TRUE, row_anno = TRUE, col_info = column_df, row_info = row_df, col_dend = TRUE, row_dend = TRUE, input_legend = FALSE)
```
